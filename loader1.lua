...
local MAIN_URL =
    "https://raw.githubusercontent.com/ronzzofficial/gag1/refs/heads/main/ui.lua.lua?v="
    .. tostring(os.time())
...
local ZANJI_LOADER_KEY_STATE = {
    ...
    AuthURL = "https://script.google.com/macros/s/AKfycbxiSNNFg9L5bYUz8SURPuSSkuHq3CYap4yOecI89UC9SVCV-bHLjGF971sJ52TGPCi8mg/exec",
